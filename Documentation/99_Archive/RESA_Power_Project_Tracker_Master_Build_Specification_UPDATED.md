...
| Scope_Financial_Configuration | Transactional | Config_ID (Auto) | User-created | Financial rates & config |
| Apparatus | Transactional | Apparatus_ID (Auto) | User-created | Individual testable units |
