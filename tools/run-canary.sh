...
(
  cd "${repo_root}"
  export PORT="${forms_runtime_port}"
...
(
  cd "${repo_root}"
  export APEX_MCP_HTTP_PORT="${fs_mcp_port}"
...
(
  cd "${repo_root}"
  export APEX_MCP_HTTP_PORT="${db_mcp_port}"
...
(
  cd "${repo_root}"
  export APEX_MCP_HTTP_PORT="${jobs_mcp_port}"
...
(
  cd "${repo_root}"
  export APEX_MCP_HTTP_PORT="${forms_mcp_port}"
  export APEX_FORMS_RUNTIME_URL="http://127.0.0.1:${forms_runtime_port}"
...
(
  cd "${repo_root}"
  export APEX_MCP_HTTP_PORT="${p6_mcp_port}"
  export APEX_P6_RUNTIME_URL="http://127.0.0.1:${p6_runtime_port}"
