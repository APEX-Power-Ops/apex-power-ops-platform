...
> Repo-owned copy established 2026-05-07 as the canonical in-repo overview surface for the live standalone `apex-power-ops-platform/` boundary. Keep the parent-root copy aligned until cutover retirement is complete.

**Version:** 2.2.0 (Supabase)
**Last Updated:** May 8, 2026 (current operating note refreshed; architecture body remains a December 11, 2025 snapshot)
...
3. `docs/OPERATOR-BOOTSTRAP-RUNBOOK.md`

Current Olares operating truth:

1. GitHub remains canonical.
2. `C:/APEX Platform/apex-power-ops-platform` is the canonical local repo root and publication boundary for active Apex Ops repo work.
3. `/home/olares/code/apex/apex-power-ops-platform` is the authoritative host mirror and active host implementation surface.
4. `C:/APEX Platform` is workstation umbrella and historical-lineage residue, not the repo publication boundary.
...
**Historical parent-root location:** see `docs/architecture/apex-lineage/root/README.md` for the preserved `Documentation/07_Application_Specs/` references.
