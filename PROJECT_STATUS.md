...
4. Use Packet 786 as the first bounded two-lane rehearsal floor, Packet 797 as the current second two-lane rehearsal and coordinator-summary floor, and Packet 787 as the first bounded evidence-attachment follow-on floor instead of reopening whether those models are viable.
...
1. preserve Packet 791 as the current promotion-eligible authoritative-host strict-profile floor, Packet 790 as the current authoritative-host strict-profile floor, Packet 789 as the current wrapper-routed strict-profile floor, Packet 788 as the current named verifier-profile floor, Packet 786 as the current first two-lane coordination floor, Packet 797 as the current second two-lane rehearsal and coordinator-summary floor, Packet 785 as the current host-qualified promotion floor, Packet 787 as the current canary evidence-routing floor, Packet 792 as the current evidence-doc alignment floor, Packet 793 as the current rehearsal/runbook alignment floor, Packet 794 as the current matrix/Codex-brief alignment floor, Packet 795 as the current authority/status-brief alignment floor, and Packet 796 as the current positive-gate provenance-attachment floor,
2. extend remaining repo-side `apex-jobs` provenance and rehearsal validation only where a later bounded packet needs it,
3. prefer the next bounded follow-on to be another similarly narrow evidence-hardening or provenance slice before considering any wider controller claim,
4. treat any later controller widening beyond those bounded follow-ons as a separate decision rather than as implied follow-on work.
