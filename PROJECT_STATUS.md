...
The next truthful repo-structure work is therefore the adjacent `pm-schema-016` singleton closure so the next remaining PM-domain residue is explicit after the `pm-schema-015i` singleton closure.
