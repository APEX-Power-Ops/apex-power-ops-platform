...
| **[GR Relay Roadmap](GR-RELAY-ROADMAP.md)** | **Forward tracker** for the **relay** lane's climb to breaker (`lvbreakertcc`) parity: the breaker-rung ladder mapped to relay status + the sequenced Chips 1–6 (trust classifier → cascade → NETA serving → field-sheet UI → fidelity close → coverage) | planning relay product work, or recording a relay chip closed | **LIVING — created 2026-06-03**; Chip 1 (`relay_trust.py`) DONE |
