...
| **[SC3 Field Terminology Mapping](SC3-FIELD-TERMINOLOGY-DRAFT.md)** | The field-tolerances-MVP **SC3** terminology layer: per-lineage element/dial-symbol vocabulary (Micrologic Ir/tr · PXR Isd/tsd · Ekip I1–I4/t1–t4 · Digitrip/GE plain-English · Micrologic-7.0 **earth-leakage** correction), trust/method field phrasing, the `Plug (Ir)`→`Rating plug (In)` fix, and the governed-narrow `tcc.field_terminology` dictionary design (the Decision-013 "verbiage" slice) | wording any element/setting/trust label on a field surface (page or B2.1 sheet) | **DRAFT — FOR OPERATOR REVIEW 2026-06-11** (task #129); nothing ships pre-red-line; `PROPOSED`-basis rows gated |
