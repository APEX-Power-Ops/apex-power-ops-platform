...
| --- | --- | --- | --- |
| 1 | `001_neta_enums.sql` | `neta` schema + 10 enum types | None (`gen_random_uuid()` support) |
...
| --- | --- | --- |
| Schema | 1 | `neta` |
| Enum types | 10 | provenance_source, provenance_status, asset_status, asset_condition, neta_standard, datasheet_status, assessment_result, result_value_kind, pm_interval_unit, pm_event_status |
| Tables | 8 | asset_classes, assets, datasheet_templates, datasheets, test_results, pm_programs, pm_schedules, pm_events |
| Indexes | 24 | FK-join + filter; incl. partial `uq_datasheet_templates_current` and partial `ix_pm_schedules_due` |
