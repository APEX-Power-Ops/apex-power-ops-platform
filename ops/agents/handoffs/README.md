...
2. `2026-04-22-parent-root-infra-database-publication-handoff.md` for the current next bounded parent-root publication tranche
3. `2026-04-22-parent-root-residual-scaffold-publication-handoff.md` when historical context on the published residual scaffold/doc tranche is needed
4. `2026-04-22-parent-root-control-plane-tests-publication-handoff.md` when historical context on the published control-plane tests tranche is needed
5. `2026-04-22-parent-root-control-plane-support-publication-handoff.md` when historical context on the published control-plane support tranche is needed
6. `2026-04-22-parent-root-control-plane-core-publication-handoff.md` when historical context on the published control-plane runtime-core tranche is needed
7. `2026-04-22-parent-root-mutation-seam-runtime-publication-handoff.md` when historical context on the published mutation-seam runtime tranche is needed
8. `2026-04-22-parent-root-operations-web-runtime-publication-handoff.md` when historical context on the published operations-web runtime tranche is needed
9. `2026-04-22-parent-root-package-source-publication-handoff.md` when historical context on the published package source tranche is needed
10. `2026-04-22-parent-root-class-a-scaffold-publication-handoff.md` when historical context on the published Class A scaffold tranche is needed
11. `2026-04-22-parent-root-bootstrap-publication-handoff.md` only when historical context on the completed first parent-root publication tranche is needed
...
3. future parent-root publication for `C:/APEX Platform/apex-power-ops-platform` as routine bounded staging against tracked `HEAD`; use `2026-04-22-parent-root-infra-database-publication-handoff.md` for the current active tranche and review the residual scaffold, control-plane tests, control-plane support, control-plane core, mutation-seam, operations-web, package, Class A, and bootstrap handoffs only as historical closure records
