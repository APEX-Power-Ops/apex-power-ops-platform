...
2. `2026-04-22-parent-root-class-a-scaffold-publication-handoff.md` for the current next bounded parent-root publication tranche
3. `2026-04-22-parent-root-bootstrap-publication-handoff.md` only when historical context on the completed first parent-root publication tranche is needed
...
3. future parent-root publication for `C:/APEX Platform/apex-power-ops-platform` as routine bounded staging against tracked `HEAD`; use `2026-04-22-parent-root-class-a-scaffold-publication-handoff.md` for the next active tranche and review `2026-04-22-parent-root-bootstrap-publication-handoff.md` only when retracing the already-completed first-introduction tranche
