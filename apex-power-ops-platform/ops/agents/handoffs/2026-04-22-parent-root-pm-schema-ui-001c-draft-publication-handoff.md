...
Use this packet to introduce the bounded `pm-schema-ui-001c` PM approval queue and cross-surface review flow implementation singleton:
...
1. it introduces only the next dependency-safe PM approval implementation tranche and does not widen into later slices such as `pm-schema-ui-001d`, `pm-schema-ui-001e`, or `pm-schema-ui-002a`
