...
Use this packet to introduce the bounded `pm-schema-ui-001e` Supabase read model and mutation store migration singleton:
...
1. it introduces only the next dependency-safe persistence migration tranche and does not widen into later slices such as `pm-schema-ui-002a`
