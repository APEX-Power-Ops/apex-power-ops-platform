...
Measured from the parent git root at `C:/APEX Platform` on 2026-04-22 after the `pm-schema-ui-003` draft publication:

- total untracked paths under `apex-power-ops-platform/`: 3926
- `apps`: 2
- `archive`: 2516
- `knowledge`: 974
- `ops`: 434
