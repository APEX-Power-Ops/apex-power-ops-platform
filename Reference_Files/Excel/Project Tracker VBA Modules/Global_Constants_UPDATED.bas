...
' ===== VERSION CONTROL =====
' =============================================
Public Const MODULE_VERSION As String = "1.1.0"
Public Const LAST_UPDATED As String = "2025-11-23"
...
' =============================================
' ?? UPDATED: Added GT_COL_REMAINING_QTY, shifted all subsequent columns by +1
...
Public Const GT_COL_REMAINING_QTY As Long = 5      ' E - REMAINING QUANTITY (NEW - counts incomplete apparatus)
Public Const GT_COL_START_DATE As Long = 6         ' F - START DATE (was E)
Public Const GT_COL_DATE_DUE As Long = 7           ' G - DATE DUE (was F)
Public Const GT_COL_DURATION As Long = 8           ' H - DURATION IN DAYS (was G)
Public Const GT_COL_PCT_COMP As Long = 9           ' I - % COMPLETION (was H)
Public Const GT_COL_NOTES As Long = 10             ' J - Notes (was I)
