...
**Purpose:** VS Code Claude handoff document for building `services/calc_engine/neta_test_plan.py`
...
**Authority note:** This is an implementation spec for one service surface. It must not be used to classify overall backend maturity or redefine governed TCC architecture outside the paired schema and DLL authority documents.
