...
class TestPlan(Base):
    ...
    sensor_id = Column(Integer, ForeignKey('tcc.etu_sensors.id'), nullable=True, index=True)
    ltpu_pickup_id = Column(Integer, ForeignKey('tcc.etu_ltpu_pickups.id'))
    ltd_band_id = Column(Integer, ForeignKey('tcc.etu_ltd_bands.id'))
    stpu_pickup_id = Column(Integer, ForeignKey('tcc.etu_stpu_pickups.id'))
    std_band_id = Column(Integer, ForeignKey('tcc.etu_std_bands.id'))
    inst_pickup_id = Column(Integer, ForeignKey('tcc.etu_inst_pickups.id'))
    gfpu_pickup_id = Column(Integer, ForeignKey('tcc.etu_gfpu_pickups.id'))
    gfd_band_id = Column(Integer, ForeignKey('tcc.etu_gfd_bands.id'))
