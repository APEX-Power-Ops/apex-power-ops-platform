...
47. the bounded `pm-schema-ui-005` draft tranche is also now published on parent-root `clean-main`
48. the bounded `pm-schema-ui-006` draft tranche is also now published on parent-root `clean-main`
49. the bounded `pm-schema-ui-001a` draft tranche is also now published on parent-root `clean-main`
50. the bounded `pm-schema-ui-001b` draft tranche is also now published on parent-root `clean-main`
51. the bounded `pm-schema-ui-001c` draft tranche is also now published on parent-root `clean-main`
52. the bounded `pm-schema-ui-001d` draft tranche is also now published on parent-root `clean-main`
53. the bounded `pm-schema-ui-001e` draft tranche is also now published on parent-root `clean-main`
54. the bounded `pm-schema-ui-002a` draft tranche is also now published on parent-root `clean-main`
55. the bounded `pm-schema-ui-002b` draft tranche is also now published on parent-root `clean-main`
56. the bounded `pm-schema-ui-002c` draft tranche is also now published on parent-root `clean-main`
57. the bounded `pm-schema-020a` draft tranche is also now published on parent-root `clean-main`
58. the bounded `pm-schema-020b` draft tranche is also now published on parent-root `clean-main`
59. the bounded `pm-schema-020c` draft tranche is also now published on parent-root `clean-main`
60. the bounded `pm-schema-ui-002d` draft tranche is also now published on parent-root `clean-main`
61. the bounded `pm-schema-020d` draft tranche is also now published on parent-root `clean-main`
62. the bounded `pm-schema-020f` draft tranche is also now published on parent-root `clean-main`
63. the bounded `pm-schema-020e.1` draft tranche is also now published on parent-root `clean-main`
64. the bounded `pm-schema-020g-a` draft tranche is also now published on parent-root `clean-main`
...
67. normal `git status`, `git diff`, and bounded `git add -- <paths>` now work against tracked `HEAD` for those already-introduced `apex-power-ops-platform/` paths
68. much of the broader subtree still remains untracked and therefore still requires deliberate introduction rather than assuming routine diff coverage
69. the parent root remains the actual git boundary even though day-to-day implementation work is platform-first inside the subtree
...
44. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-005-draft-publication-handoff.md`
45. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-006-draft-publication-handoff.md`
46. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-001a-draft-publication-handoff.md`
47. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-001b-draft-publication-handoff.md`
48. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-001c-draft-publication-handoff.md`
49. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-001d-draft-publication-handoff.md`
50. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-001e-draft-publication-handoff.md`
51. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-002a-draft-publication-handoff.md`
52. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-002b-draft-publication-handoff.md`
53. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-002c-draft-publication-handoff.md`
54. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020a-draft-publication-handoff.md`
55. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020b-draft-publication-handoff.md`
56. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020c-draft-publication-handoff.md`
57. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-ui-002d-draft-publication-handoff.md`
58. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020d-draft-publication-handoff.md`
59. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020f-draft-publication-handoff.md`
60. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020e.1-draft-publication-handoff.md`
61. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020g-a-draft-publication-handoff.md`
62. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020e.2-draft-publication-handoff.md`
63. `ops/agents/handoffs/2026-04-22-parent-root-pm-schema-020h-draft-publication-handoff.md`
64. `ops/agents/handoffs/2026-04-22-parent-root-clean-main-reconciliation-handoff.md`
65. `C:/APEX-safety-snapshots/live-root-pre-merge-divergence-2026-04-22/RECOVERY-NOTES.md`
66. `C:/APEX-safety-snapshots/live-root-pre-merge-divergence-2026-04-22/INTEGRITY-REPORT.md`
