...
- Packet 895 is the current delegated packet-template operator-prompt floor refresh floor
- Packet 896 is the current delegated operator-prompt-template packet-definition floor refresh floor
