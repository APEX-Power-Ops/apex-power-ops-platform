...
- Packet 866 is the current delegated operator-prompt-template packet-definition floor refresh floor
...
- route packet-specific operator prompts through Packet 832 as extended by Packet 858, Packet 860, Packet 862, Packet 864, and Packet 866 and `docs/operations/OLARES-AI-DELEGATED-DUAL-LANE-OPERATOR-PROMPT-TEMPLATE-2026-05-13.md`
