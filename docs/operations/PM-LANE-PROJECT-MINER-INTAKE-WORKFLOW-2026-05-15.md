...
1. Local PM intake workbench usability - active and local-current. PM Lanes 043 through 125 have built the `/pm-review/import-intake` daily workbench, local review outputs, field-prep artifacts, grouped/disclosed panels, authority-wording guard, and predictable body-control wrappers through Local Review Checklist. The next bounded local move is PM Lane 126, Local Approval Decision Draft Body Controls.
