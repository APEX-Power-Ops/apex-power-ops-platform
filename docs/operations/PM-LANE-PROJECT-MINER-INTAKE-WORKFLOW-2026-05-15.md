...
1. Local PM intake workbench usability - active and local-current. PM Lanes 043 through 121 have built the `/pm-review/import-intake` daily workbench, local review outputs, field-prep artifacts, grouped/disclosed panels, authority-wording guard, and predictable body-control wrappers through the Local Import Exception Decision Register. The next bounded local move is PM Lane 122, Local Workflow Gates Body Controls.
